...
public class PersonMain {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 System.out.println("객체 personDTO = " + personDTO); //객체의 참조주소
		 System.out.println("객체 personDTO = " + personDTO.toString());
		 
		 personDTO.setName("홍길동"); personDTO.setAge(25);
		 
		 System.out.println("이름 = " + personDTO.getName() + "\t나이 = " +
		 personDTO.getAge()); System.out.println(personDTO);
		 */
	}
